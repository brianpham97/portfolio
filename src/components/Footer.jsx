    ...
    <footer className="w-full h-40 bg-black text-white">
      <div className="flex justify-between pt-5">
        <div className="flex flex-col gap-2 pl-4 mt-3">
          ...
          <p className="cursor-pointer hover:underline hover:text-[#c9aa71]">phambri97@gmail.com</p>
          <p className="cursor-pointer hover:underline hover:text-[#c9aa71]">{'(562) 338-5219'}</p>
        </div>
      ...
      <Link to="header" smooth duration={500}>
        <h1 className="text-center text-base italic cursor-pointer hover:text-[#c9aa71] hover:underline">Designed by Brian Pham</h1>
      </Link>
    </footer>
  );
}
