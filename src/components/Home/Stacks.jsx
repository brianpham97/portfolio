...
const Stacks = () => {
  ...
  return (
      ...
      <div className="flex flex-col justify-center text-white p-4">
        <p className="self-center text-4xl underline underline-offset-8 decoration-gray-500">Tech Stacks</p>

        <div className="grid grid-cols-2 gap-4 text-center py-8 px-12 sm:grid-cols-3 sm:px-0">
          {technology.map((tech, index) => {
            return (
              <div key={index} className={`shadow-md py-2 rounded-lg ${tech.color} hover:scale-105`}>
                <a href={tech.link} target="_blank">
                <img src={tech.image} className="w-20 h-20 object-center object-contain mx-auto"/>
                </a>
            ...
            return (
              <div key={index} className={`shadow-md py-2 rounded-lg ${stack.color} hover:scale-105`}>
                <a href={stack.link} target="_blank">
                  <img src={stack.image} className="w-20 h-20 object-center object-contain mx-auto"/>
                </a>
